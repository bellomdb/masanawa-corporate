import { e as createComponent, m as maybeRenderHead, r as renderTemplate, f as createAstro, k as renderComponent, l as renderScript, p as renderSlot, o as renderHead, h as addAttribute } from './astro/server_CdnQXOD5.mjs';
import 'piccolore';
import 'clsx';
/* empty css                         */
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "vercel-analytics", "vercel-analytics", { "data-props": propsStr, "data-params": paramsStr, "data-pathname": Astro2.url.pathname })} ${renderScript($$result, "C:/Users/Besta/Masanawa corporate/node_modules/@vercel/analytics/dist/astro/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/Besta/Masanawa corporate/node_modules/@vercel/analytics/dist/astro/index.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Masanawa - Weavewell Industries Limited. Building the future of digital services in Nigeria through innovative media, e-learning, and virtual business solutions."><meta name="viewport" content="width=device-width"><meta name="keywords" content="Masanawa, Weavewell Industries, Digital Solutions, Nigeria, E-learning, Media Services, Virtual Business"><meta name="author" content="Weavewell Industries Limited"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"', '><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:title"', '><meta property="og:description" content="Building the future of digital services in Nigeria"><meta property="og:site_name" content="Masanawa"><!-- Twitter --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"', '><meta name="twitter:description" content="Building the future of digital services in Nigeria"><title>', '</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Outfit:wght@400;500;600;700;800&display=swap" rel="stylesheet"><meta name="google-adsense-account" content="ca-pub-8370465467224716"><script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8370465467224716" crossorigin="anonymous"><\/script>', `</head> <body class="bg-gray-50 text-gray-900 font-['Inter'] min-h-screen flex flex-col selection:bg-brand-purple selection:text-white"> `, " ", " ", " ", " </body></html>"])), addAttribute(Astro2.generator, "content"), addAttribute(title, "content"), addAttribute(title, "content"), title, renderHead(), renderComponent($$result, "Header", $$Header, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "Analytics", $$Index, {}));
