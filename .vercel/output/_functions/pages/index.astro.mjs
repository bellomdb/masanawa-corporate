...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const { data: projects, error } = await supabase.from("projects").select("*").eq("status", "active").order("order_index", { ascending: true });
  if (error) {
